...
def create_newsletter():
    ...
    def ensure_slide_space(needed: float) -> bool:
        ...
        print(f'ensure_slide_space checking {current_y} > {max_height} - {needed} ({max_height - needed})'); if current_y > max_height - needed:
            slide_index += 1
            if slide_index < len(content_slides):
                ...
                print('ADDING A NEW SLIDE'); new_slide = prs.slides.add_slide(prs.slide_layouts[6])
